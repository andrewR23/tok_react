...
import * as d3Class from './clusterClass.js'
...
// console.log ('nodesV2 ', nodesV2[0]);
// console.log ('nodes base ', base_nodes[0]);
// console.log ('nodes ', nodes_copy[0]);
