...
//     //const [allmakersFilter, setAllMakersFilter] = useState ([...base_])
...
//     const [dateRange, setDateRange] =   useState([1500 , 1950]); // range value -- //
...
//             let updatedRowItems = updateRows( [...rowData]); // THIS needs to change -- 
//             setRowData (updatedRowItems)
...
//     // -- 
//     function filterMakersByAttribute (att: string, val: string, bool: bool ) { 
//         // filter attributes -e.g. guild != none..... // makers / allmaker
//         let  filteredmakers : MakerType[] = makers.filter (m =>  { 
//             return m[att].includes (val) === bool;
//         });
...
//         let totalWidth = (makers.length/allmakers.length * 1800)+200;//+ Math.random ()*1000;
...
//     // -- roll over sub item
//     function handleBlockRoll (barIndex:number, groupIndex:number, subIndex:number) { 
...
//     function handlePathRoll (data, path) { 
//         //console.log ("rollover path ", data, '  ', path);

//         if (path.pathType != 12)  {
//             const ids = data.makers.map (d => d.id)
//             const mouseX = event.clientX;
//             const mouseY = event.clientY + window.scrollY;
...
//                 {/*Bar and Paths */}
//                 <g transform ='translate(0, 40) scale (.33)'>
//                     {renderPathComponents()}
//                     {renderBarComponents()}
//                 </g>
//                 {/*Force Graph  */}
//                 <g transform ='translate(0, 300) scale (.55)'>
